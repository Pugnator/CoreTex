...
namespace
{
static void ver_func(Console *self);
static void help_func(Console *self);
static void reset_func(Console *self);
static void dihalt_func(Console *self);
static void date_func(Console *self);
static void color_func(Console *self);
static void cls_func(Console *self);
static void fault_func(Console *self);
static void led_func(Console *self);
static void free_func(Console *self);
static void memdump_func(Console *self);

typedef struct command
  {
  const char* cmd;
  void (*funcptr)(Console *self);
  } command;
...
void Console::log(char c)
  {
    switch (c)
      ...
      default:
        {
          if (strlen(conbuf) + 1 >= sizeof conbuf) break;
          //I'm too lazy
          char str[2] =
            {
            0
...
void Console::background(char color)
  {
    //skip the warning about narrowing in a clean way
    char fattr = '0' + color;
...
void Console::print(char const* str)
  {
    io->writestr(str);
  }
