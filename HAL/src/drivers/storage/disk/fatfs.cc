...
FRESULT
FATdisk::move_window (FATFS* fs, /* File system object */
...
DWORD
FATdisk::clust2sect ( /* !=0: Sector number, 0: Failed - invalid cluster# */
FATFS* fs, /* File system object */
...
DWORD
FATdisk::get_fat ( /* 0xFFFFFFFF:Disk error, 1:Internal error, 2..0x0FFFFFFF:Cluster status */
FATFS* fs, /* File system object */
...
FRESULT
FATdisk::dir_sdi (DIR* dp, /* Pointer to directory object */
...
FRESULT
FATdisk::dir_next ( /* FR_OK:Succeeded, FR_NO_FILE:End of table, FR_DENIED:Could not stretch */
...
DWORD
FATdisk::ld_clust (FATFS* fs, /* Pointer to the fs object */
...
FRESULT
FATdisk::dir_find (DIR* dp /* Pointer to the directory object linked to the file name */
)
{
 FRESULT res;
 BYTE c, *dir;
...
FRESULT
FATdisk::dir_read (DIR* dp, /* Pointer to the directory object */
...
FRESULT
FATdisk::dir_remove ( /* FR_OK: Successful, FR_DISK_ERR: A disk error */
...
void
FATdisk::get_fileinfo ( /* No return code */
DIR* dp, /* Pointer to the directory object */
...
FRESULT
FATdisk::create_name (DIR* dp, /* Pointer to the directory object */
...
FRESULT
FATdisk::follow_path ( /* FR_OK(0): successful, !=0: error code */
...
int
FATdisk::get_ldnumber ( /* Returns logical drive number (-1:invalid drive) */
...
BYTE
FATdisk::check_fs ( /* 0:FAT boor sector, 1:Valid boor sector but not FAT, 2:Not a boot sector, 3:Disk error */
FATFS* fs, /* File system object */
...
FRESULT
FATdisk::find_volume ( /* FR_OK(0): successful, !=0: any error occurred */
...
FRESULT
FATdisk::validate ( /* FR_OK(0): The object is valid, !=0: Invalid */
...
FRESULT
FATdisk::mount (FATFS* fs, /* Pointer to the file system object (NULL:unmount)*/
...
FRESULT
FATdisk::open (FIL* fp, /* Pointer to the blank file object */
...
FRESULT
FATdisk::f_read (FIL* fp, /* Pointer to the file object */
...
FRESULT
FATdisk::close (FIL *fp /* Pointer to the file object to be closed */
)
{
 FRESULT res;
...
FRESULT
FATdisk::chdir (const TCHAR* path /* Pointer to the directory path */
)
{
 FRESULT res;
 DIR dj;
...
FRESULT
FATdisk::lseek (FIL* fp, /* Pointer to the file object */
...
FRESULT
FATdisk::f_opendir (DIR* dp, /* Pointer to directory object to create */
...
FRESULT
FATdisk::closedir (DIR *dp /* Pointer to the directory object to be closed */
)
{
 FRESULT res;
...
FRESULT
FATdisk::f_readdir (DIR* dp, /* Pointer to the open directory object */
...
FRESULT
FATdisk::stat (const TCHAR* path, /* Pointer to the file path */
               FILINFO* fno /* Pointer to file information to return */
               )
{
 FRESULT res;
...
FRESULT
FATdisk::getfree (const TCHAR* path, /* Path name of the logical drive number */
...
FRESULT
FATdisk::truncate (FIL* fp /* Pointer to the file object */
)
{
 FRESULT res;
 DWORD ncl;
...
FRESULT
FATdisk::unlink (const TCHAR* path /* Pointer to the file or directory path */
)
{
 FRESULT res;
 DIR dj, sdj;
...
FRESULT
FATdisk::mkdir (const TCHAR* path /* Pointer to the directory path */
)
{
 FRESULT res;
 DIR dj;
...
FRESULT
FATdisk::chmod (const TCHAR* path, /* Pointer to the file path */
...
FRESULT
FATdisk::rename (const TCHAR* path_old, /* Pointer to the object to be renamed */
...
FRESULT
FATdisk::utime (const TCHAR* path, /* Pointer to the file/directory name */
...
FRESULT
FATdisk::mkfs (const TCHAR* path, /* Logical drive number */
...
TCHAR*
FATdisk::gets (TCHAR* buff, /* Pointer to the string buffer to read */
...
void
FATdisk::putc_bfd (putbuff* pb, TCHAR c)
{
 UINT bw;
 int i;
...
int
FATdisk::putc (TCHAR c, /* A character to be output */
               FIL* fp /* Pointer to the file object */
               )
{
 putbuff pb;
...
int
FATdisk::puts (const TCHAR* str, /* Pointer to the string to be output */
               FIL* fp /* Pointer to the file object */
               )
{
 putbuff pb;
...
int
FATdisk::printf (FIL* fp, /* Pointer to the file object */
