...
#include <stdarg.h>
void
(*xfunc_out) (unsigned char); /* Pointer to the output stream */
static char *outptr;
...
void
xputs ( /* Put a string to the default device */
...
void
xfputs ( /* Put a string to the specified device */
void
(*func) (unsigned char), /* Pointer to the output function */
        const char* str /* Pointer to the string */
        )
{
 void
...
static
void
xvprintf (const char* fmt, /* Pointer to the format string */
...
void
xprintf ( /* Put a formatted string to the default device */
...
void
xfprintf ( /* Put a formatted string to the specified device */
void
(*func) (unsigned char), /* Pointer to the output function */
          const char* fmt, /* Pointer to the format string */
          ... /* Optional arguments */
...
void
put_dump (const void* buff, /* Pointer to the array to be dumped */
...
#if _USE_XFUNC_IN
unsigned char
(*xfunc_in) (void); /* Pointer to the input stream */
...
int
xgets ( /* 0:End of stream, 1:A line arrived */
...
int
xfgets ( /* 0:End of stream, 1:A line arrived */
unsigned char
(*func) (void), /* Pointer to the input stream function */
        char* buff, /* Pointer to the buffer */
        int len /* Buffer length */
        )
{
