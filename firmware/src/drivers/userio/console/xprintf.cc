...
void Console::xputs (					/* Put a string to the default device */
...
void Console::xprintf (			/* Put a formatted string to the default device */
	const char*	fmt,	/* Pointer to the format string */
	...					/* Optional arguments */
)
{
...
void Console::xsprintf (			/* Put a formatted string to the memory */
