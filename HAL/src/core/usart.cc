...
void
USART::init (char channel, word baud)
{
 switch (channel)
 {
  case 1:
...
USART::signup ()
{
 ...
 else
 {
  ...
  HARDWARE_TABLE[USART1_HANDLER + channel - 1] =
    extirq ? (word) extirq : (word) this;
 }
}
