...
#define __NOP                                     __no_operation            /*!< no operation intrinsic in IAR Compiler */
   ...
   */
  extern uint32_t
  __STREXB (uint8_t value, uint8_t* addr);
   ...
   */
  extern uint32_t
  __STREXH (uint16_t value, uint16_t* addr);
   ...
   */
  extern uint32_t
  __STREXW (uint32_t value, uint32_t* addr);
